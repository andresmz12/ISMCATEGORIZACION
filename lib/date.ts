...
// (see import) to avoid UTC-midnight rounding shifting a date by a day.
// Date-range filters must match that anchor, or the last day of any range
// silently drops every transaction dated on it.
