  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        // Only shown once a superadmin flips chatbotEnabled on for the active business —
        // hidden entirely otherwise, not just blocked.
        ...(activeBusiness?.chatbotEnabled ? [{ href: '/chat', label: t('nav.chat'), highlight: true, icon: (<svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>) }] : []),
      ],
    },
    {
      label: 'Finanzas',
      items: [
        ...
        { href: '/plaid', label: t('nav.plaid'), highlight: true, icon: (<svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>) },
      ],
    },
    {
      label: 'Organización',
