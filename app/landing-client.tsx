  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-br from-[#0d2233] via-[#1B4965] to-[#1a5276] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-0 lg:pt-28">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex gap-6 mt-10 pt-8 border-t border-white/10">
                {[
                  ...
                  { val: '<5min', label: lang === 'es' ? 'para 500 transacciones' : 'for 500 transactions' },
                ].map(s => (
                  <div key={s.val}>
            ...
            <div className="relative lg:mt-0 mt-8 pb-0">
              {/* Floating cards */}
              <div className="absolute -left-6 top-12 z-10 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3 border border-gray-100">
              ...
              <div className="absolute -right-4 top-1/3 z-10 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3 border border-gray-100">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">{t.pain.title}</h2>
